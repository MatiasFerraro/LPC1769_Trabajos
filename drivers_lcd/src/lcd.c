...
{
	    init_port(LCD_PORT,LCD_RS, SALIDA);
        init_port(LCD_PORT,LCD_EN, SALIDA);
        init_port(LCD_PORT,LCD_D7, SALIDA);
        init_port(LCD_PORT,LCD_D6, SALIDA);
        init_port(LCD_PORT,LCD_D5, SALIDA);
        init_port(LCD_PORT,LCD_D4, SALIDA);
}
void lcd_init(void)
{
...
{
   if (data.D4==1)	outputhigh(LCD_PORT,LCD_D4);
	else		outputlow(LCD_PORT,LCD_D4);
   if (data.D5==1)	outputhigh(LCD_PORT,LCD_D5);
    else		outputlow(LCD_PORT,LCD_D5);
   if (data.D6==1)	outputhigh(LCD_PORT,LCD_D6);
	else		outputlow(LCD_PORT,LCD_D6);
   if (data.D7==1)	outputhigh(LCD_PORT,LCD_D7);
	else		outputlow(LCD_PORT,LCD_D7);
   if (data.RS==1)	outputhigh(LCD_PORT,LCD_RS);
	else		outputlow(LCD_PORT,LCD_RS);
   delay();
   outputhigh(LCD_PORT,LCD_EN);
   delay();
   outputlow(LCD_PORT,LCD_EN);
   delay();
}
